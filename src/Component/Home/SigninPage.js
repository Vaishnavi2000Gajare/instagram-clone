                        ...
                        <Row>
                            ...
                            <Col xs={6}>
                                <form>
                                    ...
                                    <h6 style={{color:'dimgray'}}><b>Sign up to see photos and videos <br>
                                        </br>from your friends.</b></h6>
                                        <div class="d-grid gap-2 me-5 col-8 " style={{marginLeft:'90px'}}>
                                        ...
                                        <div class="inputField" style={{width:'70%'}}>
                                            ...
                                            <input type="text" placeholder='Full Name'style={{marginTop:'15px'}}/>
                                            <input type="text" placeholder='Username' style={{marginTop:'15px'}}/>
                                            <input type="text" placeholder='Password' style={{marginTop:'15px'}}/>
                                           
                                        </div>
                                     
                                        <h6 style={{textAlign:'center',marginTop:'20px',color:'dimgray'}}>People who use our service may have uploaded <br></br>your contact information to Instagram. Learn More</h6>
                                        <h6 style={{textAlign:'center',marginTop:'20px',color:'dimgray'}}>By signing up, you agree to our Terms , Data <br></br>Policy and Cookies Policy </h6>
                                        <div class="d-grid gap-2 col-6 mx-auto" style={{marginTop:'22px'}}>
                                                <button class="btn btn-primary" type="button">Sign up</button>
                                                
                                                </div>
                                    <p style={{marginTop:'30px'}}>Have an Account?<a href="£" style={{textDecoration:'none'}}>Log in</a></p>
